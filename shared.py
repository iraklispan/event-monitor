...
EVENTS_HEADER = [
    ...
    "minimum_stay", "includes_venues",          # col 18 – renamed from includes_meeting_spaces
    # ── new ──
...
SPACES_HEADER = [
    ...
    "venue_event_name", "venue_date", "venue_from", "venue_to",  # new
    "venue_notes", "service_notes",                               # new
]
